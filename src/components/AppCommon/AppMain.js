                                ...
                                <div className="row slider-text align-items-center justify-content-center">
                                    <div className="col-md-8 text-center col-sm-12 ">
                                        ...
                                        <p data-aos="fade-up" data-aos-delay="200">
                                            <a href="#" className="btn btn-white btn-outline-white">Get Started</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row no-gutters">
                            <div className="col-md-6">
                                <div className="sched d-block d-lg-flex">
                                    <div className="bg-image order-2" style={{ backgroundImage: `url('img/dishes_4.jpg')`}} data-aos="fade"></div>
                                ...
                                <div className="sched d-block d-lg-flex">
                                    <div className="bg-image" style={{ backgroundImage: `url('img/dishes_1.jpg')` }} data-aos="fade"></div>
                                    <div className="text">
                            ...
                            <div className="col-md-6">
                                <div className="sched d-block d-lg-flex">
                                    <div className="bg-image order-2" style={{ backgroundImage: `url('img/dishes_2.jpg')`}} data-aos="fade"></div>
                                    <div className="text order-1">
                                ...
                                <div className="sched d-block d-lg-flex">
                                    <div className="bg-image" style={{ backgroundImage: `url('img/dishes_3.jpg')`}} data-aos="fade"></div>
                                    <div className="text">
